...
| **Tangle** (`near`) | the pipeline with the shipped policies — the row orders 03 and 13 tune | the 10 nearest surviving memories | the gold turns among them (a merged survivor cites every turn it absorbed) |
