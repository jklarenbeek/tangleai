...
`@tangleai/memory/consolidation` supplies bounded deterministic topic previews, Jaren lexical routing, supported structured synthesis with durable recovery, host-driven triggers and Jaren contract operations, qualified source snapshots, immutable
