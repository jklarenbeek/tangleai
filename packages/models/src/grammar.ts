...
import { createStructuredOutput } from './structured.ts';
import { checkOutcome } from '@jarenjs/core/check';
import { createRoutedClient } from './routing.ts';
...
export function createGrammarAuthor(options: {
  ...
  return {
    author: (question: any, hooks: Record<string, any> = {}) => generate.generate([
