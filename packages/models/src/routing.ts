...
export type ModelLimits = { deadlineMs?: number, outputTokens?: number, reasoningTokens?: number; };
export type ModelContext = { purpose: 'author' | 'subcall' | 'embedding' | 'stylesheet', grammar?: string, depth?: number, limits?: ModelLimits; };
