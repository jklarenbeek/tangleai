...
> `@tangleai/jaren/program` — the public action program over environment slots. **Read it when**
...
```js
import { program } from '@tangleai/jaren/program';
...
The isolated program pen costs **<!--fact:bundle.program-->15,678<!--/fact--> bytes**
