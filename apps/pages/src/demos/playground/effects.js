...
import { loadExample, loadDataset, blankSession, sessionOf, sessionFilename, sessionDocument, sessionFromDocument, sessionToLoaded } from './play.js';
const SHARE_TOKEN_LIMIT = 8000;
/** @param {any} app @param {any} playStore @param {any} env */
export function playEffects(app, playStore, env) { return {
...
'play-share': async (props, dispatch) => {
