import { program, from, chunk, stat, answer, map, reduce, type ProgramDocument } from '@tangleai/linq/program';
...
const rootDocument: ProgramDocument = rootProgram.program(['data']).stat('data', 'meta').answer('meta').schema;
new LinqBuildError('JL0101', 'Invalid options', '/steps/0');
void rootDocument;
