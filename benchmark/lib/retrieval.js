 ...
 * @param {any[]} memories
 * @param {{ embedder?: import('@tangleai/agents/program-result').Embedder, storage?: any }} [options]
 */
 ...
 *   embedder?: import('@tangleai/agents/program-result').Embedder }} config
 ...
 * @param {import('@tangleai/agents/program-result').Embedder} embedder
 ...
 *   live?: { embedder: import('@tangleai/agents/program-result').Embedder, label: string } | null,
