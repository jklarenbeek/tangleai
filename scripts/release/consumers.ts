...
export async function testConsumers(root = ROOT, options: { registry?: boolean; runtimeOnly?: boolean } = {}) {
  ...
  try {
    ...
    if (!options.runtimeOnly) {
      ...
      const browser = { crypto: globalThis.crypto, console, TextEncoder, TextDecoder, URL, URLSearchParams, AbortController, performance, setTimeout, clearTimeout, queueMicrotask, tangleConsumer: undefined as any };
