...
const data = name => JSON.parse(readFileSync(new URL((name === 'long-horizon' ? '../../benchmark/jaren-long-horizon.json' : '../../benchmark/historical/'+name+'.json'),import.meta.url),'utf8'));
/**
...
export const horizonFacts = { name:'historical horizon and retrieval measurements', docs:()=>['benchmark/MIGRATED-JAREN.md','docs/AI-MECHANISM-ROADMAP.md', 'packages/models/README.md', 'packages/context/README.md', 'packages/agents/README.md', 'packages/jaren/README.md', 'packages/jaren/docs/AUTHORING.md'], facts:()=>({
'horizon.measured': () => {
